    ...
    return (
      <div className="text-center py-12">
        <div className="w-16 h-16 bg-[var(--muted)] rounded-full flex items-center justify-center mx-auto mb-4">
          <svg className="w-8 h-8 text-[var(--on-surface)]/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <CardContent className="p-6">
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-sm text-[var(--on-surface)]/70">4.8</span>
              </div>
            </div>
            
            <p className="text-[var(--on-surface)]/70 mb-4" data-testid="text-salon-address">
              {salon.address}
            </p>
            
            <div className="space-y-2 mb-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-[var(--on-surface)]/70">Herrenhaarschnitt</span>
                <span className="font-semibold">60,00 €</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-[var(--on-surface)]/70">Damenschnitt</span>
                <span className="font-semibold">60,00 €</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-[var(--on-surface)]/70">Färben</span>
                <span className="font-semibold">60,00 €</span>
              </div>
            </div>
            ...
            <div className="flex space-x-2">
              <Button
                className="flex-1 bg-[var(--primary)] hover:opacity-90 text-black font-semibold transition-all"
              ...
              <Button
                variant="outline"
                className="px-4 py-2 border-[var(--border)] hover:bg-[var(--muted)] transition-all"
