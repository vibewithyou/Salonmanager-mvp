    ...
    <div className="rounded-lg border border-[var(--border)] bg-[var(--surface)] text-[var(--on-surface)] p-4 flex flex-col gap-3">
      ...
      <div className="mt-1">
        <button
          ...
          className="inline-flex items-center px-4 py-2 rounded-md bg-[var(--primary)] text-black font-medium hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-[var(--primary)]"
          aria-label={`Termin im Salon ${name} buchen`}
        >
          Termin buchen
        </button>
      </div>
