          ...
          <div className="flex items-center mt-4 space-x-4">
            <div className="flex items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                currentStep >= 1 ? 'bg-gold-500 text-dark-900' : 'bg-gray-300 dark:bg-gray-600'
              }`}>
                1
              </div>
              <span className={`ml-2 text-sm font-medium ${currentStep >= 1 ? '' : 'text-gray-500'}`}>
                Service
              </span>
            </div>
            ...
            <div className="flex items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                currentStep >= 2 ? 'bg-gold-500 text-dark-900' : 'bg-gray-300 dark:bg-gray-600'
              }`}>
                2
              </div>
              <span className={`ml-2 text-sm font-medium ${currentStep >= 2 ? '' : 'text-gray-500'}`}>
                Stylist
              </span>
            </div>
            <div className="flex-1 h-px bg-gray-300 dark:bg-gray-600"></div>
            <div className="flex items-center">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                currentStep >= 3 ? 'bg-gold-500 text-dark-900' : 'bg-gray-300 dark:bg-gray-600'
              }`}>
                3
              </div>
              <span className={`ml-2 text-sm font-medium ${currentStep >= 3 ? '' : 'text-gray-500'}`}>
                Termin
              </span>
            </div>
          </div>
                  ...
                  <label key={service.id} className="block cursor-pointer">
                    ...
                    <div className={`p-4 border-2 rounded-lg transition-all ${
                      selectedService?.id === service.id
                        ...
                        : 'border-gray-200 dark:border-gray-600 hover:border-gold-400'
                    }`}>
                      <div className="flex justify-between items-start">
                        ...
                        <span className="text-xl font-bold text-gold-500" data-testid="text-service-price">
